                        ...
                        <div class="row">
                            <div class="col-12 col-md-4 ">
                                <div class="card border-0">
                                    <div class="card-body py-4" style="background-color: beige;">
                                        <h5 class="mb-2 fw-bold">
                                            Jumlah Data Training
                                        </h5>
                                        <p class="mb-2 fw-bold"><?php echo number_format($jumlah_datatraining, 0, ",", ".") ?></p>
                                        <div class="mb-0">
                            ...
                            <div class="col-12 col-md-4 ">
                                <div class="card  border-0">
                                    <div class="card-body py-4" style="background-color: beige;">
                                        ...
                                        <p class="mb-2 fw-bold"><?php echo number_format($jumlah_datauji, 0, ",", ".") ?></p>
                                        <div class="mb-0">
                                            <span class="badge text-success me-2">
                                            </span>
                                            <span class="fw-bold">
